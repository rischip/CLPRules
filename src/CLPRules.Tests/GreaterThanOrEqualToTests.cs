...
namespace CLPRules.Tests
{
    ...
    public class GreaterThanOrEqualToTests
    {
        ...
        {
            Assert.IsTrue(GreaterThanOrEqualToComparison.GreaterThanOrEqualTo(UInt32.MaxValue, UInt32.MinValue));
            Assert.IsTrue(GreaterThanOrEqualToComparison.GreaterThanOrEqualTo(UInt32.MaxValue, UInt32.MaxValue));
        }
        [TestMethod]
        public void TestGreaterThanOrEqualToInt64()
        {
            Assert.IsTrue(GreaterThanOrEqualToComparison.GreaterThanOrEqualTo(Int64.MaxValue, Int64.MinValue));
            Assert.IsTrue(GreaterThanOrEqualToComparison.GreaterThanOrEqualTo(Int64.MaxValue, Int64.MaxValue));
        }
        [TestMethod]
        public void TestGreaterThanOrEqualToUInt64()
        {
            Assert.IsTrue(GreaterThanOrEqualToComparison.GreaterThanOrEqualTo(UInt64.MaxValue, UInt64.MinValue));
            Assert.IsTrue(GreaterThanOrEqualToComparison.GreaterThanOrEqualTo(UInt64.MaxValue, UInt64.MaxValue));
        }
        [TestMethod]
